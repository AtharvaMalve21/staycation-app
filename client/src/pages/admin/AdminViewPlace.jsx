      ...
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-6 space-y-10">
        ...
        <div className="flex justify-between items-center flex-wrap gap-4">
          ...
          <div className="flex gap-3">
            <button onClick={() => navigate(`/places/${place._id}/edit`)} className="p-2 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition">
              <Pencil className="w-5 h-5" />
            </button>
            <button onClick={deletePlace} className="p-2 bg-red-100 text-red-600 rounded-full hover:bg-red-200 transition">
